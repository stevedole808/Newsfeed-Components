...
function createMenu(menuItem){
  ...
  menuItem.forEach( text =>{
    let organizedList = document.createElement('li'); 
    organizedList.textContent = text;
    unorderedList.appendChild(organizedList);
  })

 
  buttonMenu.addEventListener('click', item =>{
